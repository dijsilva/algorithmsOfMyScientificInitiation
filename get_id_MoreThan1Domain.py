...
for sist in ref:
    ...
    path_ncbi_A = '/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/blast_out/ncbi_info_{}_ch_{}_MoreThan1Domain.txt'.format(sist,sist,chains[0])
    path_tax_A = '/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/blast_out/pre_tax_{}_ch_{}_MoreThan1Domain.txt'.format(sist, sist, chains[0])
    path_ncbi_B = '/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/blast_out/ncbi_info_{}_ch_{}_MoreThan1Domain.txt'.format(sist, sist, chains[1])
    path_tax_B = '/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/blast_out/pre_tax_{}_ch_{}_MoreThan1Domain.txt'.format(sist, sist, chains[1])
    ...
    #lista com as espécies que aparecem apenas uma vez e são comuns nos dois sistemas
    conc = []
    ...
    out_A = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/blast_out/id_seq_and_species_{}_{}_MoreThan1Domain.txt'.format(sist, sist, chains[0]),'w')
    out_B = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/blast_out/id_seq_and_species_{}_{}_MoreThan1Domain.txt'.format(sist, sist, chains[1]),'w')
