...
for sist in ref:
    ...
    system = sist[0:4]
    fastas = glob.glob1("/home/dsilva/Dropbox/{}/files".format(system), 'fas*')
    chain1 = fastas[0][-1]
    chain2 = fastas[1][-1]
    chains = (chain1, chain2)
    path_ncbi_A = '/home/dsilva/Dropbox/{}/files/blast_out/ncbi_info_{}_ch_{}_MoreThan1Domain.txt'.format(system,system,chains[0])
    path_tax_A = '/home/dsilva/Dropbox/{}/files/blast_out/pre_tax_{}_ch_{}_MoreThan1Domain.txt'.format(system, system, chains[0])
    path_ncbi_B = '/home/dsilva/Dropbox/{}/files/blast_out/ncbi_info_{}_ch_{}_MoreThan1Domain.txt'.format(system, system, chains[1])
    path_tax_B = '/home/dsilva/Dropbox/{}/files/blast_out/pre_tax_{}_ch_{}_MoreThan1Domain.txt'.format(system, system, chains[1])
