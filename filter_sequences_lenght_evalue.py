...
for system in ref:
    ...
    print('{}'.format(system))
    ncbi_a = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/psi_blast_out/psi_ncbi_info_{}_ch_{}.txt'.format(system, system, chains[0]), 'r')
    ncbi_b = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/psi_blast_out/psi_ncbi_info_{}_ch_{}.txt'.format(system, system, chains[1]), 'r')
    ref_a = {}
    ref_b = {}
    for line in ncbi_a:
    ...
    sequences_a = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/psi_blast_out/psi_sequences_{}_{}_l_filtred.fas'.format(system, system, chains[0]), 'r')
    sequences_b = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/psi_blast_out/psi_sequences_{}_{}_l_filtred.fas'.format(system, system, chains[1]), 'r')
    ...
    out_a = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/psi_blast_out/psi_sequences_{}_{}_le_filtred.fas'.format(system, system, chains[0]), 'w')
    out_b = open('/home/dsilva/data_pibic_2018/proteins/2ch/{}/files/psi_blast_out/psi_sequences_{}_{}_le_filtred.fas'.format(system, system, chains[1]), 'w')
